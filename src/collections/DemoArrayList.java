...
public class DemoArrayList {
    ...
    public static void main (String args[]){
        ...
        l.add(10);
        System.out.println("After adding 10 , List : " + l);
        System.out.println("After adding 10 , List Size : " + l.size());
        /*
        l.add("hello");
        ...
        */
        ...
        System.out.println("After removing 10 , List : " + l);
        System.out.println("After removing 10 , List Size : " + l.size());
